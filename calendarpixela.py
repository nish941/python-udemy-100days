# this is copied frim net 
# so you need to make hell lot of changes for it to work but do give it a try
...
URL = "https://pixe.la/v1/users/lunarishi1122/graphs/graph1.html"
TODAY = dt.now()
...
def add_pixel():
    endpoint = "https://pixe.la/v1/users/lunarishi1122/graphs/graph1/"
    pixel_add = {
        "date": format_date(),
...
def del_pixel():
    endpoint = f"https://pixe.la/v1/users/lunarishi1122/graphs/graph1/{format_date()}"
